...
export class Backend implements backendInterface {
    ...
    async submitApplication(arg0: Application): Promise<ApplicationId> {
        if (this.processError) {
            try {
                const result = await this.actor.submitApplication(to_candid_Application_n18(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function to_candid_Application_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Application): _Application {
...
function to_candid_record_n19(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        paymentStatus: to_candid_PaymentStatus_n22(_uploadFile, _downloadFile, value.paymentStatus),
        applicationId: value.applicationId,
        date: value.date,
        name: value.name,
        email: value.email,
